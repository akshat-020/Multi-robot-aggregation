...
def surr_data_tb0(data0):
        ...
        for g in range(len(p0)):
            if p0[g]==float('inf'):
                ...
                continue
        #print(len(p0))
        minvalue_of_ranges0=(np.argmin(p0[55:125]))-90     ## have to find the index of the minimum value then find the degree deltaij
...
def surr_data_tb1(data1):
        ...
        for g in range(len(p1)):
            if p1[g]==float('inf'):
                ...
                continue
        #print(len(p1))
        minvalue_of_ranges1=(np.argmin(p1[55:125]))-90      ## have to find the index of the minimum value then find the degree deltaij
...
def surr_data_tb2(data2):
        ...
        for g in range(len(p2)):
            if p2[g]==float('inf'):
                ...
                continue
        #print(len(p2))
        minvalue_of_ranges2=90-(np.argmin(p2[55:125]))    ## have to find the index of the minimum value then find the degree deltaij
